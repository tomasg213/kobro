    ...
    <div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <Card className="lg:col-span-2">
            <CardHeader className="flex flex-row items-center justify-between pb-3">
              <CardTitle className="text-lg font-semibold text-[#1a3a2a]">Últimas Transacciones</CardTitle>
              <Link 
                href="/dashboard/transactions"
                className="text-sm text-[#4a7c59] hover:underline flex items-center gap-1 font-medium"
              >
            ...
            <CardContent>
              {recentTransactions.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <Link 
                    href="/dashboard/transactions"
                    className="text-sm text-[#4a7c59] hover:underline mt-2 inline-block"
                  >
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className="h-10 w-10 rounded-full bg-[#4a7c59]/10 flex items-center justify-center">
                            <Users className="h-5 w-5 text-[#4a7c59]" />
                          </div>
                          <div>
                            <p className="font-medium text-sm text-[#1a3a2a]">{client?.name || "Cliente"}</p>
                        ...
                        <div className="text-right">
                          <p className="font-semibold text-[#1a3a2a]">{formatCurrency(transaction.amount)}</p>
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-lg font-semibold text-[#1a3a2a]">Accesos Rápidos</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-[#1a3a2a]">Clientes</span>
                </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="font-medium text-[#1a3a2a]">Comprobantes</span>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-[#1a3a2a]">Nueva Campaña</span>
                </div>
                <ArrowRight className="h-4 w-4 text-gray-400 group-hover:translate-x-1 transition-transform" />
              </Link>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-[#1a3a2a]">Plantillas</span>
                </div>
                <ArrowRight className="h-4 w-4 text-gray-400 group-hover:translate-x-1 transition-transform" />
              </Link>
            </CardContent>
        ...
        {campaigns.length > 0 && (
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-3">
              <CardTitle className="text-lg font-semibold text-[#1a3a2a]">Campañas Recientes</CardTitle>
              <Link 
                ...
                {campaigns.slice(0, 3).map((campaign) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <p className="font-medium text-sm text-[#1a3a2a]">{campaign.name}</p>
                      <Badge 
